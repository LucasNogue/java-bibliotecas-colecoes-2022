...
public class Candidato {
    ...
    public List<String> respostasAdicionais = new ArrayList<>();
    public static List<String> perguntasAdicionais = new ArrayList<>();
    ...
    public static void cadastraCandidato() throws IOException {
        ...
        while (lerPergunta.hasNext()) {
            ...
            listaDeCandidatos.add(new Candidato(respostaNome,respostaEmail, respostaIdade, respostaTelefone));
